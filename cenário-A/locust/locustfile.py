...
class SAMLIdPFonteUser(HttpUser):
    """
    Cenario A - IdP como fonte de atributos (Figura 1a do artigo).
    Nao ha Autoridade de Atributos: o IdP autentica o usuario, recupera
    os atributos na sua propria base institucional (LDAP) e ja devolve
    a assercao SAML pronta ao SP. Fluxo com 5 mensagens (Tabela 1).
    """
    ...
    @task
    def fluxo_idp_fonte_1_a_5(self):
        ...
        try:
            ...
            fire_custom(
                self.environment,
                "4 - IdP autentica, recupera atributos institucionais e gera a assercao SAML",
                step_ms,
                len(r4.content or b""),
            ...
            if not saml_form and already_authenticated:
                ...
                fire_custom(
                    self.environment,
                    "5 - SP recebe a assercao e decide o acesso",
                    step_ms,
                    len(r4.content or b""),
                    None
                )
                ...
                fire_custom(
                    ...
                    step_ms,
                    len(r5.content or b""),
                    None if r5.ok and final_ok else Exception(f"HTTP {r5.status_code}")
                )

                if not r5.ok or not final_ok:
                    debug_page("Falha no passo 5 - SP nao confirmou o acesso", r5)
                    return
            ...
            print("LOGIN OK - fluxo 1 a 5 completo")
