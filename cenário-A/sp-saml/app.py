...
SCENARIO_LABEL = "Cenário A · IdP como fonte de atributos"
SCENARIO_SUBTITLE = "O IdP libera os atributos institucionais diretamente, sem Autoridade de Atributos"
FLOW_STEPS = ["SP", "DS", "IdP", "SP"]
AA_SOURCED_ATTRIBUTES = set()
...
def render_attributes_table(attributes):
    preferred_order = [
        "uid",
        "cn",
        "displayName",
...
def index():
        ...
        <body style="min-height: 100vh; display: flex; align-items: center; justify-content: center; padding: 24px;">
            <div class="card" style="max-width: 640px; width: 100%; padding: 40px;">
                ...
                <p class="note" style="margin-bottom: 24px;">
                    No fluxo com IdP como fonte, o próprio IdP autentica o
                    usuário e envia ao SP a asserção SAML com os atributos
                    institucionais.
                </p>
    ...
    rows = render_attributes_table(attributes)
    ...
    <body>
        <header style="background: linear-gradient(135deg, #c2410c, #ea580c); color: white; padding: 32px 24px;">
